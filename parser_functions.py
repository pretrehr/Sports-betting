...
from auxiliary_functions import merge_dicts, get_future_opponents
from database_functions import (is_in_db, is_in_db_site, add_name_to_db, get_close_name,
                                get_close_name2, get_id_by_site, get_id_by_opponent)
